...
var Command = /** @class */ (function () {
    function Command(Data) {
        var _this = this;
        var _a, _b, _c;
        this.GetArg = function (name, args) {
            if (!args)
                return;
            var filt = args.filter(function (v) { return v.name === name; })[0];
            if (!filt)
                return;
            return filt.value;
        };
        this.run = function (message, client, args) { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, { Worked: false, Error: new Error('There is no run function!') }];
            });
        }); };
        this.Name = Data.Name;
        this.Desc = Data.Desc;
